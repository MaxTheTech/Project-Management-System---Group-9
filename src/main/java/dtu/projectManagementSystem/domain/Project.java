...
public class Project{
    ...
    public ProjectActivity getActivity(String activityName) throws Exception { //Emil Wille Andersen (s194501)
        for (ProjectActivity activity : projectActivities){
            if (activity.getName().equals(activityName)){
                return activity;
            }
        } throw new Exception("Project activity "+ activityName+" does not exist");
    }
